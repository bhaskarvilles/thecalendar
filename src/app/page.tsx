...
export default function Home() {
  ...
  }, [origin, device, density, layout, theme]);
        ...
        <header className="mb-8 flex flex-col gap-4 md:mb-10 md:flex-row md:items-end md:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
              Dynamic iOS calendar wallpaper with{" "}
              <span className="text-emerald-300">days left</span> in the year.
            </h1>
            <p className="max-w-xl text-sm text-white/60 md:text-base">
              Pick your iPhone or iPad model, choose how dense you want the
              calendar, then drop the generated URL into the Shortcuts app to
              update your lock screen automatically every day.
            </p>
          </div>
          <div className="rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-xs text-emerald-100 shadow-[0_0_40px_rgba(16,185,129,0.35)]">
            <p className="font-semibold tracking-wide">
              Live: today is highlighted, days left auto‑update.
            </p>
            <p className="mt-1 text-[11px] text-emerald-100/80">
              Once your automation is set up, you don&apos;t need to touch it
              again.
            </p>
          </div>
        </header>
          ...
          <div className="space-y-5 rounded-2xl border border-white/10 bg-[#050816]/80 p-4 shadow-[0_22px_60px_rgba(0,0,0,0.75)] backdrop-blur">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-white/50">
                  {theme === "liquid-glass" &&
                    "iOS 26 style with glassmorphism effects, blur, and modern gradients."}
                  {theme === "dark" &&
                    "Classic dark theme with high contrast for readability."}
                  {theme === "light" &&
                    "Clean light theme perfect for bright environments."}
                  {theme === "neon" &&
                    "Cyberpunk-inspired neon theme with glowing accents."}
                  {theme === "minimal" &&
                    "Ultra-minimal black and white design."}
                  {theme === "gradient" &&
                    "Vibrant gradient theme with colorful backgrounds."}
                </p>
              </div>
            ...
            <div className="space-y-2 border-t border-white/10 pt-4">
              ...
              <div className="flex flex-col gap-2 rounded-xl border border-white/15 bg-black/60 p-3 text-xs font-mono text-white/70 md:flex-row md:items-center md:justify-between">
                <div className="min-w-0 flex-1 truncate">{wallpaperUrl}</div>
                <button
                  type="button"
                  onClick={handleCopy}
